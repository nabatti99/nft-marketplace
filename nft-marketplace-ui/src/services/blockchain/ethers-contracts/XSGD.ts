...
export interface XSGDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface XSGD extends BaseContract {
  connect(runner?: ContractRunner | null): XSGD;
  waitForDeployment(): Promise<this>;

  interface: XSGDInterface;
